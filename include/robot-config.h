...
#define MOTOR_LF_PORT                   PORT14
#define MOTOR_LB_PORT                   PORT12
#define MOTOR_RF_PORT                   PORT18
#define MOTOR_RB_PORT                   PORT19
#define MOTOR_LG_PORT                   PORT1
#define MOTOR_RG_PORT                   PORT16
#define MOTOR_LT_PORT                   PORT11
#define MOTOR_AR_PORT                   PORT10  
#define INERTIAL_PORT                   PORT9
